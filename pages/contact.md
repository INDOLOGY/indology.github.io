...
The committee operates on a weekly rota, so writing to an individual means that 
they have to pass the message to the address above so that it reaches the person on duty.
